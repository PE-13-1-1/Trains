...
public class DBAdapterTrains 
{
	...
	public long insertWay(int trainNumber, String stationName, String arrival, String departure)
	{
	...
	public boolean deleteWay(int trainNumber)
	{
	...
	public Cursor getWay(int trainNumber) throws SQLException
	{
	...
	//---updates a record---
	public boolean updateWay(int trainNumber, String stationName, String arrival, String departure)
	{
